...
VALUES
  (
    13,
    'X-Burguer',
    'Pão brioche, carne bovina 120g, queijo cheddar.',
    23.50,
  ...
  (
    14,
    'X-Salada',
    'Pão brioche, carne bovina 150g, alface fatiada, tomate, cebola e queijo cheddar.',
    25.90,
  ...
  (
    15,
    'X-Bacon',
    'Pão brioche, carne bovina 120g, queijo cheddar e fatias de bacon artesanal.',
    27.90,
  ...
  (
    16,
    'Coca Lata',
    'Coca bem gelada, pode trazer de acompanhamento um copo com gelo e limão (opcional)',
    5.50,
    '1760124844_james-yarema-wQFmDhrvVSs-unsplash.jpg'
  ),
  (
    17,
    'Batata Frita',
...
INSERT INTO
  `produtos_especiais` (`id`, `nome`, `descricao`, `preco`, `imagem`)
VALUES
  (
    1,
    'Burger Premium Especial',
    'Pão artesanal, carne angus 200g, queijo gorgonzola, cebola caramelizada e molho especial da casa',
    45.90,
    '1760468299_burger especial.jpeg'
  ),
  (
    2,
    'Combo Executivo',
    'X-Bacon + Batata Frita + Refrigerante + Sobremesa',
    39.90,
    '1760468307_combo especial.jpeg'
  ),
  (
    3,
    'Milk Shake Premium',
    'Milk shake de chocolate belga com sorvete artesanal',
    18.90,
    '1760468316_milk shake.jpeg'
  );
...
CREATE TABLE
  `system_logs` (
    ...
    `dados` longtext CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid (`dados`)),
...
VALUES
  (
    ...
    'INFO',
    'info',
    'Sistema de reset de pedidos configurado',
    NULL,
    '2025-10-17 18:02:59'
  ),
  (
    ...
    '{\"cliente_id\":12,\"pedidos_removidos\":0,\"backup_table\":\"pedidos_backup_2025_10_17\",\"timestamp\":1760724219}',
    '2025-10-17 18:03:39'
  ),
  (
    3,
    ...
    'INFO',
    'sucesso',
    'Colunas observacoes e numero_pedido verificadas/criadas',
    NULL,
    '2025-10-17 18:06:40'
  );
...
VALUES
  ...
  (
    14,
    'Rafael',
    'rmrpaisdoai@fmauis.cnm',
    '$2y$10$SOyiG.4lCGzYVL.in9uY/.O6dpTxH/22W574XcYLDeESmnESekbSC',
    'cliente'
  );
...
ALTER TABLE `pedidos_backup_2025_10_17` ADD PRIMARY KEY (`id`),
ADD KEY `id_produto` (`id_produto`),
ADD KEY `idx_pedidos_cliente` (`id_cliente`),
ADD KEY `idx_pedidos_status` (`status`),
ADD KEY `idx_pedidos_pagamento` (`status_pagamento`),
...
ALTER TABLE `produtos_especiais` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `carrinho` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 25;
...
ALTER TABLE `pedidos_backup_2025_10_17` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT;

ALTER TABLE `produtos` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 18;

ALTER TABLE `produtos_especiais` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 4;

ALTER TABLE `system_logs` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 4;

ALTER TABLE `usuarios` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 15;

ALTER TABLE `carrinho` ADD CONSTRAINT `carrinho_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE,
