...
SELECT COUNT(*) as itens_no_carrinho FROM carrinho;
...
INSERT INTO carrinho (id, id_cliente, id_produto, quantidade, data_adicao)
SELECT id, id_cliente, id_produto, quantidade, data_adicao
FROM carrinho_backup;
...
DELETE FROM carrinho WHERE id_cliente = 1 AND id_produto = 1;
...
SELECT id, nome, preco, disponivel FROM produtos ORDER BY id;
